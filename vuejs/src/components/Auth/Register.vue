            ...
            <div class="card-body">
              ...
              <form @submit.prevent="submitForm" id="registerForm" novalidate>
                ...
                <div class="mb-3">
                  ...
                  >
                  <p v-for="error in v$.password_confirmation.$errors" :key="error.$uid" class="text-danger m-0"> 
                  {{ error.$message }} 
                  </p>
                </div>
                ...
                <div class="mb-3 form-check">
                  ...
                  Acepto los <router-link to="/terms" class="link-secondary">Términos de Servicio</router-link> y la <router-link to="/privacy" class="link-secondary">Política de Privacidad</router-link>
                  </label>
                ...
                <div class="d-grid gap-2 mb-3">
                  <button class="btn btn-primary" type="submit" :disabled="v$.$invalid">Registrarse</button>
                </div>
...
<style scoped>
    ...
    .or-line::before, .or-line::after {
        ...
        position: absolute;
        top: 50%;
        width: 100px; /* Aumenta este valor para hacer las líneas más largas */
        height: 2px; /* Aumenta el grosor de la línea */
