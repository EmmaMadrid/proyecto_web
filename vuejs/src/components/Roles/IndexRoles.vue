          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12">
                <button class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#roleModal">Add Role</button>
              </div>
            </div>
              ...
              <tbody> 
                <tr v-for="item in items" :key="item.id" class="border-b">
                  ...
                  <td class="permissions-column">
                    <span v-for="permission in item.permissionName" :key="permission.id" class="permission-tag">{{ permission }}</span>
                  </td>
                  <td>
